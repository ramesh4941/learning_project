                                ...
                                <tr class="invoice-list">
                                    ...
                                    <td class="text-center">
                                        <div class="form-check form-check-md"> 
                                            <input class="form-check-input form-checked-success attandance-radio" type="radio" name="Radio1" id="Radio-sm">
                                        </div>
                                    </td>
                                    <td class="text-center">
                                        <div class="form-check form-check-md">
                                            <input class="form-check-input form-checked-warning attandance-radio" type="radio" name="Radio1" id="Radio-md">
                                        </div>
                                    </td>
                                    <td class="text-center">
                                        <div class="form-check form-check-md">
                                            <input class="form-check-input form-checked-danger attandance-radio" type="radio" name="Radio1" id="Radio-lg" checked="">
                                        </div>
                                    </td>
                                </tr>   
                                @endforeach
